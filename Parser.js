...
yy: {},
symbols_: {"error":2,"lisp":3,"expression":4,"eof":5,"number":6,"string":7,"symbol":8,"list":9,"(":10,"items":11,")":12,"$accept":0,"$end":1},
terminals_: {2:"error",5:"eof",6:"number",7:"string",8:"symbol",10:"(",12:")"},
productions_: [0,[3,2],[4,1],[4,1],[4,1],[4,1],[9,3],[9,2],[11,2],[11,1]],
...
case 1:return $$[$0-1];
break;
case 2:this.$ = new Literal($$[$0]);/*number*/
break;
case 3:this.$ = new Literal($$[$0]);/*string*/
break;
case 4:this.$ = new Symbol($$[$0]);/*symbol*/
break;
case 5:this.$ = $$[$0];/*list*/
break;
case 6:this.$=$$[$0-1];
...
case 7:this.$=[];
break;
case 8:this.$=$$[$0];this.$.unshift($$[$0-1]);
break;
case 9:this.$=[$$[$0]]
break;
}
},
table: [{3:1,4:2,6:[1,3],7:[1,4],8:[1,5],9:6,10:[1,7]},{1:[3]},{5:[1,8]},{5:[2,2],6:[2,2],7:[2,2],8:[2,2],10:[2,2],12:[2,2]},{5:[2,3],6:[2,3],7:[2,3],8:[2,3],10:[2,3],12:[2,3]},{5:[2,4],6:[2,4],7:[2,4],8:[2,4],10:[2,4],12:[2,4]},{5:[2,5],6:[2,5],7:[2,5],8:[2,5],10:[2,5],12:[2,5]},{4:11,6:[1,3],7:[1,4],8:[1,5],9:6,10:[1,7],11:9,12:[1,10]},{1:[2,1]},{12:[1,12]},{5:[2,7],6:[2,7],7:[2,7],8:[2,7],10:[2,7],12:[2,7]},{4:11,6:[1,3],7:[1,4],8:[1,5],9:6,10:[1,7],11:13,12:[2,9]},{5:[2,6],6:[2,6],7:[2,6],8:[2,6],10:[2,6],12:[2,6]},{12:[2,8]}],
...
rules: [/^(?:\s+)/,/^(?:\()/,/^(?:\))/,/^(?:[-+]?[0-9]*\.?[0-9]+)/,/^(?:"(\\.|[^\\"])*")/,/^(?:[a-zA-Z][a-zA-Z0-9]*)/,/^(?:$)/],
